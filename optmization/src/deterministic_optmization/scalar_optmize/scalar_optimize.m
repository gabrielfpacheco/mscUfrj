function varargout = scalar_optimize(varargin)
% scalar_optimize M-file for scalar_optimize.fig
%      scalar_optimize, by itself, creates a new scalar_optimize or raises the existing
%      singleton*.
%
%      H = scalar_optimize returns the handle to a new scalar_optimize or the handle to
%      the existing singleton*.
%
%      scalar_optimize('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in scalar_optimize.M with the given input arguments.
%
%      scalar_optimize('Property','Value',...) creates a new scalar_optimize or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the SCALAR_OPTIMIZE before scalar_optimize_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to scalar_optimize_OpeningFcn via varargin.
%
%      *See SCALAR_OPTIMIZE Options on GUIDE's Tools menu.  Choose "SCALAR_OPTIMIZE allows only one
%      instance to run (singleton)".
%
% See also: GUIDE, GUIDATA, GUIHANDLES

% Edit the above text to modify the response to help scalar_optimize

% Last Modified by GUIDE v2.5 10-Dec-2015 01:53:48

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @scalar_optimize_OpeningFcn, ...
                   'gui_OutputFcn',  @scalar_optimize_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before scalar_optimize is made visible.
function scalar_optimize_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for scalar_optimize
...
% UIWAIT makes scalar_optimize wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = scalar_optimize_OutputFcn(hObject, eventdata, handles) 
